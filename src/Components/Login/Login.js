    ...
    return (
        <div className='min-h-screen'>
            <div className='min-h-screen bg-[#e4bcc4]   flex justify-center items-center'>
                <div className="card w-96 bg-base-100 signup-card mx-auto ">
                        ...
                        <div className="card-actions justify-center">
                            ...
                            <div>
                                <form autoComplete='disabled' onSubmit={handleSubmit(onSubmit)} className='w-[300px] mx-auto  mb-5 gap-y-2'>
                                    ...
                                    <button type='submit' className="btn btn-primary w-full mt-4 normal-case">Login</button>
                                ...
                                <button onClick={() => googleSignIn()} type='submit' className="btn btn-primary w-full mt-1 normal-case">Continue With Google</button>
                            </div>
                        </div>
